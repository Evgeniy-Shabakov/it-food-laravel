...
class RestaurantUpdateRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'at_restaurant_at_counter_available.required' => 'Поле "Доступен подача в ресторане (выдача у прилавка)" обязательно для заполнения',
            'at_restaurant_at_counter_available.boolean' => 'Поле "Доступен подача в ресторане (выдача у прилавка)" должно быть boolean',
            'at_restaurant_to_table_available.required' => 'Поле "Доступен подача в ресторане (к столику)" обязательно для заполнения',
            'at_restaurant_to_table_available.boolean' => 'Поле "Доступен подача в ресторане (к столику)" должно быть boolean',
            'at_restaurant_to_parking_available.required' => 'Поле "Доступна доставка на парковку у ресторане (к машине)" обязательно для заполнения',
            'at_restaurant_to_parking_available.boolean' => 'Поле "Доступна доставка на парковку у ресторане (к машине)" должно быть boolean',
